...
%
% x = cplexmiqp(H,f,Aineq,bineq,Aeq,beq,sostype,sosind,soswt) solves the
...
%
% x = cplexmiqp(H,f,Aineq,bineq,Aeq,beq,sostype,sosind,soswt,lb,ub) defines a
...
% set lb=[] and ub=[].
%
% x = cplexmiqp(H,f,Aineq,bineq,Aeq,beq,sostype,sosind,soswt,lb,ub,ctype,x0)
% sets the starting point to x0. If all design variables are continuous,
% set ctype=[].
%
% x =
% cplexmiqp(H,f,Aineq,bineq,Aeq,beq,sostype,sosind,soswt,lb,ub,ctype,x0,optio
...
% cplexoptimset. If you do not want to give an initial point, set x0=[].
%
